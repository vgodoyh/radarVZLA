        ...
        <article class="organization-summary organization-summary--obu">
            ...
            <div class="organization-summary__main">
                ...
                <div class="organization-posts-grid">
                    ...
                    @forelse (($obuPosts ?? collect())->take(3) as $post)
                        <a
                            href="{{ $post['url'] ?? '#' }}"
                            target="_blank"
                            rel="noopener noreferrer"
                    ...
                    @empty
                        @foreach ([
                            [
                                'title' => 'Informe: Situación de las universidades en Venezuela',
                                'date' => '30 jul. 2026',
                                'image' => 'assets/img/placeholders/article.svg',
                            ],
                            [
                                'title' => 'Comunicado: Libertad académica bajo presión en universidades públicas',
                                'date' => '28 jul. 2026',
                                'image' => 'assets/img/placeholders/article.svg',
                            ],
                            [
                                'title' => 'Investigación: Cierre de espacios de investigación y censura académica',
                                'date' => '24 jul. 2026',
                                'image' => 'assets/img/placeholders/article.svg',
                            ],
                        ] as $post)
                            <a href="#" class="organization-post-mini">
                                <img
